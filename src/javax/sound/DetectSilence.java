...
public class DetectSilence {
            ...
            Runnable runner = new Runnable() {
                ...
                public void run() {
                    ...
                    while (running) {
                        ...
                        /*
                         * Iniciou a fala, começa a gravação (out)
                         */
                    	if (isSilence && level > 0.01) {
                    		out = new ByteArrayOutputStream();
                    		isSilence = false;
                    	}
                    	if (!isSilence) {
                    		temp = new File("audio/temp_"+(gerador.nextInt() & Integer.MAX_VALUE)+".wav");
                    	}
	...
	public File getAudioFile(File file) {
